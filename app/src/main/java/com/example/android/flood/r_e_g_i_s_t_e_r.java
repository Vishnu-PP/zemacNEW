...
public class r_e_g_i_s_t_e_r extends AppCompatActivity {
                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(r_e_g_i_s_t_e_r.this, "User Created", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getApplicationContext(), MainActivity.class));
                        }else  {
                            Toast.makeText(r_e_g_i_s_t_e_r.this, "Error!" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
